      ...
      <div id="dropdowns" className="absolute top-12 right-0 w-[564px]">
        <div id="apps" className="absolute max-h-[436px] w-80 ml-20 bg-zinc-800/80 bg-cover ring-zinc-500 ring-1 overflow-hidden hidden">
          <ul className="max-h-[436px] py-4 grid grid-cols-3 gap-2 items-center justify-center overflow-y-auto snap-y">
            ...
            <AppLink appName="Github" redirectLink="https://github.com/pmmp/PocketMine-MP" iconUrl="/icons/GitHub-Mark-Light-64px.png" />
            <AppLink appName="Docs" redirectLink="https://pmmp.readthedocs.org/" iconUrl="/icons/docs.ico" />
            <AppLink appName="Poggit" redirectLink="https://poggit.pmmp.io" iconUrl="/icons/poggit.png" />
        ...
        <div id="notifications" className="absolute max-h-[642px] w-[384px] ml-28 bg-zinc-800/80 bg-cover ring-zinc-500 ring-1 overflow-hidden hidden">
          ...
          <div>
            <svg width="479" height="2" viewBox="0 0 479 2" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div id="user" className="absolute max-h-[694px] w-[300px] ml-56 bg-zinc-800/80 bg-cover ring-zinc-500 ring-1 overflow-hidden hidden">
          <div className="min-h-[48px] my-2 flex gap-2 align-items-center">
            ...
            <div>
              ...
              <h4 className="text-sm text-zinc-400">Signed in with {AuthUser.firebaseUser?.providerId || 'none'}</h4>
            </div>
          </div>
          <div>
            <svg width="300" height="3" viewBox="0 0 300 2" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M-13 1L479.008 1" stroke="#71717a"/>
            </svg>
          </div>
          <ul className="max-h-[592px] grid grid-cols-1 gap-1 overflow-y-auto snap-y">
            ...
            <li className="snap-end">
              <button className="w-full h-full">
                <a className="p-3 flex gap-3 hover:bg-zinc-900/90">
                  <div className="w-6 h-6">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M0.375 12C0.375 18.4203 5.57967 23.625 12 23.625C18.4203 23.625 23.625 18.4203 23.625 12C23.625 5.57972 18.4203 0.375 12 0.375C5.57972 0.375 0.375 5.57967 0.375 12ZM12 20.625V3.375C16.7674 3.375 20.625 7.23333 20.625 12C20.625 16.7674 16.7667 20.625 12 20.625Z" fill="white"/>
                    </svg>
                  </div>
                  <p>Appearance: Dark</p>
                </a>
