...
const Notification = ({ name, version, timestamp = 0, redirectUrl, iconUrl = '/icons/missing.png' }) => {
    ...
    <li className="snap-end">
      <Link href={redirectUrl}>
        <a className="py-2 flex justify-between hover:bg-zinc-900/90">
          <div className="ml-3">
            <p className="max-w-[320px] break-all font-semibold text-white">{name} v{version}</p>
