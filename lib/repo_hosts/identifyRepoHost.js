...
import GITHUB_APP from '../initGitHubApp'
...
async function testGithub(url, auth) {
  // https://regex101.com/r/db8oag/3
  const regExp =
    /^(?:http[s]?:\/\/)?((?:[a-zA-Z0-9][-a-zA-Z0-9]{0,61}[a-zA-Z0-9]?\.)?[a-zA-Z0-9]{1,2}(?:[-a-zA-Z0-9]{0,252}[a-zA-Z0-9])?\.[a-zA-Z]{2,63})?(?:\/|^)([a-zA-Z0-9-_]+)\/?([a-zA-Z0-9-_]+)\/?(?:[a-zA-Z0-9-_]+\/?)?(?:([a-zA-Z0-9-_]+)\/?)?/im
  ...
  try {
    ...
    const octokit = GITHUB_APP.octokit
