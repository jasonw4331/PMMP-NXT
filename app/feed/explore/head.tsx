export default async function TrendingHead() {
  ...
  return (
    <>
      ...
      <title>Trending | PMMP NXT</title>

      <meta name='twitter:card' content='summary' />
      <meta name='twitter:url' content='https://pmmp.io/nxt' />
      <meta name='twitter:title' content='PMMP NXT | Trending' />
      <meta
        name='twitter:description'
        content={`The pulse of what's trending in the PocketMine community. Check out the latest plugin releases, updates, and everything else that people are looking at right now.`}
      />
      <meta name='twitter:creator' content='@jasonw_4331' />

      <meta property='og:type' content='website' />
      <meta property='og:title' content='PMMP NXT | Trending' />
      <meta
